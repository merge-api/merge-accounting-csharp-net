...
# **CreditNotesList**
> PaginatedCreditNoteList CreditNotesList (string xAccountToken, DateTime? createdAfter = null, DateTime? createdBefore = null, string cursor = null, string expand = null, bool? includeRemoteData = null, DateTime? modifiedAfter = null, DateTime? modifiedBefore = null, int? pageSize = null, string remoteId = null)
...
namespace Example
{
    public class CreditNotesListExample
    {
        public static void Main()
        {
            ...
            var expand = payments;  // string | Which relations should be returned in expanded form. Multiple relation names should be comma separated without spaces. (optional) 
            ...
            try
            {
                PaginatedCreditNoteList result = apiInstance.CreditNotesList(xAccountToken, createdAfter, createdBefore, cursor, expand, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
...
# **CreditNotesRetrieve**
> CreditNote CreditNotesRetrieve (string xAccountToken, Guid id, string expand = null, bool? includeRemoteData = null)
...
namespace Example
{
    public class CreditNotesRetrieveExample
    {
        public static void Main()
        {
            ...
            try
            {
                CreditNote result = apiInstance.CreditNotesRetrieve(xAccountToken, id, expand, includeRemoteData);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
