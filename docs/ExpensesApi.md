...
namespace Example
{
    public class ExpensesListExample
    {
        public static void Main()
        {
            ...
            try
            {
                PaginatedExpenseList result = apiInstance.ExpensesList(xAccountToken, companyId, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
