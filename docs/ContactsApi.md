...
# **ContactsList**
> PaginatedContactList ContactsList (string xAccountToken, DateTime? createdAfter = null, DateTime? createdBefore = null, string cursor = null, bool? includeDeletedData = null, bool? includeRemoteData = null, DateTime? modifiedAfter = null, DateTime? modifiedBefore = null, int? pageSize = null, string remoteId = null)
...
namespace Example
{
    public class ContactsListExample
    {
        public static void Main()
        {
            ...
            try
            {
                PaginatedContactList result = apiInstance.ContactsList(xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
...
# **ContactsRetrieve**
> Contact ContactsRetrieve (string xAccountToken, Guid id, bool? includeRemoteData = null)
...
namespace Example
{
    public class ContactsRetrieveExample
    {
        public static void Main()
        {
            ...
            try
            {
                Contact result = apiInstance.ContactsRetrieve(xAccountToken, id, includeRemoteData);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
