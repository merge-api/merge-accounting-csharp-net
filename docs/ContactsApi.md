# Merge.AccountingClient.Api.ContactsApi
...
# **ContactsList**
> PaginatedContactList ContactsList (string xAccountToken, DateTime? createdAfter = null, DateTime? createdBefore = null, string cursor = null, string expand = null, bool? includeRemoteData = null, DateTime? modifiedAfter = null, DateTime? modifiedBefore = null, int? pageSize = null, string remoteId = null)
...
namespace Example
{
    public class ContactsListExample
    {
        public static void Main()
        {
            ...
            var expand = addresses,phone_numbers;  // string | Which relations should be returned in expanded form. Multiple relation names should be comma separated without spaces. (optional) 
            ...
            try
            {
                PaginatedContactList result = apiInstance.ContactsList(xAccountToken, createdAfter, createdBefore, cursor, expand, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
...
# **ContactsRetrieve**
> Contact ContactsRetrieve (string xAccountToken, Guid id, string expand = null, bool? includeRemoteData = null)
...
namespace Example
{
    public class ContactsRetrieveExample
    {
        public static void Main()
        {
            ...
            try
            {
                Contact result = apiInstance.ContactsRetrieve(xAccountToken, id, expand, includeRemoteData);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
