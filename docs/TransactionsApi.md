...
namespace Example
{
    public class TransactionsListExample
    {
        public static void Main()
        {
            ...
            try
            {
                PaginatedTransactionList result = apiInstance.TransactionsList(xAccountToken, companyId, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
