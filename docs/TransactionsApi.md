# Merge.AccountingClient.Api.TransactionsApi
...
namespace Example
{
    public class TransactionsListExample
    {
        public static void Main()
        {
            ...
            var companyId = companyId_example;  // string | If provided, will only return accounting transactions for this company. (optional) 
            ...
            try
            {
                PaginatedTransactionList result = apiInstance.TransactionsList(xAccountToken, companyId, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, transactionDateAfter, transactionDateBefore);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling TransactionsApi.TransactionsList: " + e.Message );
 ...
 **companyId** | **string**| If provided, will only return accounting transactions for this company. | [optional] 
...
> Transaction TransactionsRetrieve (string xAccountToken, Guid id, bool? includeRemoteData = null)
...
namespace Example
{
    public class TransactionsRetrieveExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            try
            {
                Transaction result = apiInstance.TransactionsRetrieve(xAccountToken, id, includeRemoteData);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling TransactionsApi.TransactionsRetrieve: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
