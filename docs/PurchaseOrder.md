...
**Status** | **string** | The purchase order&#39;s status. | [optional] 
...
**Customer** | **Guid?** | The purchase order&#39;s customer. | [optional] 
**Vendor** | **Guid?** | The purchase_order&#39;s vendor. | [optional] 
**Memo** | **string** | A memo attached to the purchase order. | [optional] 
**TotalAmount** | **float?** | The purchase order&#39;s total amount. | [optional] 
**Currency** | **string** | The purchase order&#39;s currency. | [optional] 
