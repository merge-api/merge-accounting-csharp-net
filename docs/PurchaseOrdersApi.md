...
# **PurchaseOrdersList**
> PaginatedPurchaseOrderList PurchaseOrdersList (string xAccountToken, DateTime? createdAfter = null, DateTime? createdBefore = null, string cursor = null, bool? includeDeletedData = null, bool? includeRemoteData = null, DateTime? modifiedAfter = null, DateTime? modifiedBefore = null, int? pageSize = null, string remoteId = null)
...
namespace Example
{
    public class PurchaseOrdersListExample
    {
        public static void Main()
        {
            ...
            try
            {
                PaginatedPurchaseOrderList result = apiInstance.PurchaseOrdersList(xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
...
> PurchaseOrder PurchaseOrdersRetrieve (string xAccountToken, Guid id, bool? includeRemoteData = null)
...
namespace Example
{
    public class PurchaseOrdersRetrieveExample
    {
        public static void Main()
        {
            ...
            try
            {
                PurchaseOrder result = apiInstance.PurchaseOrdersRetrieve(xAccountToken, id, includeRemoteData);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
