...
# **PurchaseOrdersList**
> PaginatedPurchaseOrderList PurchaseOrdersList (string xAccountToken, DateTime? createdAfter = null, DateTime? createdBefore = null, string cursor = null, string expand = null, bool? includeRemoteData = null, DateTime? modifiedAfter = null, DateTime? modifiedBefore = null, int? pageSize = null, string remoteId = null)
...
namespace Example
{
    public class PurchaseOrdersListExample
    {
        public static void Main()
        {
            ...
            var expand = line_items,delivery_address;  // string | Which relations should be returned in expanded form. Multiple relation names should be comma separated without spaces. (optional) 
            ...
            try
            {
                PaginatedPurchaseOrderList result = apiInstance.PurchaseOrdersList(xAccountToken, createdAfter, createdBefore, cursor, expand, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
...
> PurchaseOrder PurchaseOrdersRetrieve (string xAccountToken, Guid id, string expand = null, bool? includeRemoteData = null)
...
namespace Example
{
    public class PurchaseOrdersRetrieveExample
    {
        public static void Main()
        {
            ...
            try
            {
                PurchaseOrder result = apiInstance.PurchaseOrdersRetrieve(xAccountToken, id, expand, includeRemoteData);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
