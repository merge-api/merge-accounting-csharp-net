...
# **JournalEntriesList**
> PaginatedJournalEntryList JournalEntriesList (string xAccountToken, DateTime? createdAfter = null, DateTime? createdBefore = null, string cursor = null, string expand = null, bool? includeRemoteData = null, DateTime? modifiedAfter = null, DateTime? modifiedBefore = null, int? pageSize = null, string remoteId = null)
...
namespace Example
{
    public class JournalEntriesListExample
    {
        public static void Main()
        {
            ...
            var expand = lines,payments;  // string | Which relations should be returned in expanded form. Multiple relation names should be comma separated without spaces. (optional) 
            ...
            try
            {
                PaginatedJournalEntryList result = apiInstance.JournalEntriesList(xAccountToken, createdAfter, createdBefore, cursor, expand, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
...
> JournalEntry JournalEntriesRetrieve (string xAccountToken, Guid id, string expand = null, bool? includeRemoteData = null)
...
namespace Example
{
    public class JournalEntriesRetrieveExample
    {
        public static void Main()
        {
            ...
            try
            {
                JournalEntry result = apiInstance.JournalEntriesRetrieve(xAccountToken, id, expand, includeRemoteData);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
