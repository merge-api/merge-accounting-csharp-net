...
namespace Example
{
    public class TrackingCategoriesListExample
    {
        public static void Main()
        {
            ...
            var companyId = companyId_example;  // string | If provided, will only return tracking categories for this company. (optional) 
            ...
            try
            {
                PaginatedTrackingCategoryList result = apiInstance.TrackingCategoriesList(xAccountToken, companyId, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteFields, remoteId, showEnumOrigins);
 ...
 **companyId** | **string**| If provided, will only return tracking categories for this company. | [optional] 
...
> TrackingCategory TrackingCategoriesRetrieve (string xAccountToken, Guid id, bool? includeRemoteData = null, string remoteFields = null, string showEnumOrigins = null)
...
namespace Example
{
    public class TrackingCategoriesRetrieveExample
    {
        public static void Main()
        {
            ...
            try
            {
                TrackingCategory result = apiInstance.TrackingCategoriesRetrieve(xAccountToken, id, includeRemoteData, remoteFields, showEnumOrigins);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
