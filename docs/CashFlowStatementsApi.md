# Merge.AccountingClient.Api.CashFlowStatementsApi
...
namespace Example
{
    public class CashFlowStatementsListExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new CashFlowStatementsApi(config);
            var xAccountToken = xAccountToken_example;  // string | Token identifying the end user.
            var companyId = companyId_example;  // string | If provided, will only return cash flow statements for this company. (optional) 
            ...
            try
            {
                PaginatedCashFlowStatementList result = apiInstance.CashFlowStatementsList(xAccountToken, companyId, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling CashFlowStatementsApi.CashFlowStatementsList: " + e.Message );
 ...
 **companyId** | **string**| If provided, will only return cash flow statements for this company. | [optional] 
...
> CashFlowStatement CashFlowStatementsRetrieve (string xAccountToken, Guid id, bool? includeRemoteData = null)
...
namespace Example
{
    public class CashFlowStatementsRetrieveExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            try
            {
                CashFlowStatement result = apiInstance.CashFlowStatementsRetrieve(xAccountToken, id, includeRemoteData);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling CashFlowStatementsApi.CashFlowStatementsRetrieve: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
