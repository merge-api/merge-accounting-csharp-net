...
namespace Example
{
    public class CashFlowStatementsListExample
    {
        public static void Main()
        {
            ...
            try
            {
                PaginatedCashFlowStatementList result = apiInstance.CashFlowStatementsList(xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
