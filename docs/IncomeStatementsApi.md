...
> PaginatedIncomeStatementList IncomeStatementsList (string xAccountToken, DateTime? createdAfter = null, DateTime? createdBefore = null, string cursor = null, bool? includeDeletedData = null, bool? includeRemoteData = null, DateTime? modifiedAfter = null, DateTime? modifiedBefore = null, int? pageSize = null, string remoteId = null)
...
namespace Example
{
    public class IncomeStatementsListExample
    {
        public static void Main()
        {
            ...
            try
            {
                PaginatedIncomeStatementList result = apiInstance.IncomeStatementsList(xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
