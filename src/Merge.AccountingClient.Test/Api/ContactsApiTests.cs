...
namespace Merge.AccountingClient.Test.Api
{
    ...
    public class ContactsApiTests : IDisposable
    {
        ...
        public void ContactsListTest()
        {
            ...
            //var response = instance.ContactsList(xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
        ...
        public void ContactsRetrieveTest()
        {
            ...
            //Guid id = null;
            //bool? includeRemoteData = null;
            //var response = instance.ContactsRetrieve(xAccountToken, id, includeRemoteData);
