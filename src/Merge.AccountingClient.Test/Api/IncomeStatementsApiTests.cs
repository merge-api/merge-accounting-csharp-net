...
namespace Merge.AccountingClient.Test.Api
{
    ...
    public class IncomeStatementsApiTests : IDisposable
    {
        ...
        public void IncomeStatementsListTest()
        {
            ...
            //var response = instance.IncomeStatementsList(xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
