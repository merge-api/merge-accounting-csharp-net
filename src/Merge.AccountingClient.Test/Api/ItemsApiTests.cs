...
namespace Merge.AccountingClient.Test.Api
{
    ...
    public class ItemsApiTests : IDisposable
    {
        ...
        public void ItemsListTest()
        {
            ...
            //var response = instance.ItemsList(xAccountToken, createdAfter, createdBefore, cursor, expand, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
        ...
        public void ItemsRetrieveTest()
        {
            ...
            //string expand = null;
            //bool? includeRemoteData = null;
            //var response = instance.ItemsRetrieve(xAccountToken, id, expand, includeRemoteData);
