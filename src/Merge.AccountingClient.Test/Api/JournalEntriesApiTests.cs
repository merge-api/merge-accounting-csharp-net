...
namespace Merge.AccountingClient.Test.Api
{
    ...
    public class JournalEntriesApiTests : IDisposable
    {
        ...
        public void JournalEntriesListTest()
        {
            ...
            //var response = instance.JournalEntriesList(xAccountToken, companyId, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, transactionDateAfter, transactionDateBefore);
