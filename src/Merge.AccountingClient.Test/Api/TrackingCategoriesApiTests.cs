...
namespace Merge.AccountingClient.Test.Api
{
    ...
    public class TrackingCategoriesApiTests : IDisposable
    {
        ...
        public void TrackingCategoriesListTest()
        {
            ...
            //var response = instance.TrackingCategoriesList(xAccountToken, createdAfter, createdBefore, cursor, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
