...
namespace Merge.AccountingClient.Test.Api
{
    ...
    public class VendorCreditsApiTests : IDisposable
    {
        ...
        public void VendorCreditsListTest()
        {
            ...
            //var response = instance.VendorCreditsList(xAccountToken, companyId, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, transactionDateAfter, transactionDateBefore);
