...
namespace Merge.AccountingClient.Test.Api
{
    ...
    public class AccountsApiTests : IDisposable
    {
        ...
        public void AccountsListTest()
        {
            ...
            //var response = instance.AccountsList(xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
        ...
        public void AccountsRetrieveTest()
        {
            ...
            //Guid id = null;
            //bool? includeRemoteData = null;
            //var response = instance.AccountsRetrieve(xAccountToken, id, includeRemoteData);
