...
namespace Merge.AccountingClient.Test.Api
{
    ...
    public class AttachmentsApiTests : IDisposable
    {
        ...
        public void AttachmentsListTest()
        {
            ...
            //var response = instance.AttachmentsList(xAccountToken, createdAfter, createdBefore, cursor, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
