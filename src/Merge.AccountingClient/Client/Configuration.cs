...
namespace Merge.AccountingClient.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api.merge.dev/api/accounting/v1";
        ...
        public Configuration(
            ...
            string basePath = "https://api.merge.dev/api/accounting/v1") : this()
        {
        ...
        {
            String report = "C# SDK (Merge.AccountingClient) Debug Report:\n";
