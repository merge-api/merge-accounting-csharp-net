...
namespace Merge.AccountingClient.Model
{
    ...
    public partial class JournalLine : IEquatable<JournalLine>, IValidatableObject
    {
        ...
        public JournalLine(string remoteId = default(string), Guid? account = default(Guid?), float? netAmount = default(float?), Guid? trackingCategory = default(Guid?), Guid? contact = default(Guid?), string description = default(string))
        {
