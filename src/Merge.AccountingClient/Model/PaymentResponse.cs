...
namespace Merge.AccountingClient.Model
{
    ...
    public partial class PaymentResponse : IEquatable<PaymentResponse>, IValidatableObject
    {
        ...
        public PaymentResponse(Payment model = default(Payment), List<WarningValidationProblem> warnings = default(List<WarningValidationProblem>), List<ErrorValidationProblem> errors = default(List<ErrorValidationProblem>), List<DebugModeLog> logs = default(List<DebugModeLog>))
        {
            // to ensure "model" is required (not null)
            this.Model = model ?? throw new ArgumentNullException("model is a required property for PaymentResponse and cannot be null");
            // to ensure "warnings" is required (not null)
            this.Warnings = warnings ?? throw new ArgumentNullException("warnings is a required property for PaymentResponse and cannot be null");
            // to ensure "errors" is required (not null)
            this.Errors = errors ?? throw new ArgumentNullException("errors is a required property for PaymentResponse and cannot be null");
            this.Logs = logs;
        }
