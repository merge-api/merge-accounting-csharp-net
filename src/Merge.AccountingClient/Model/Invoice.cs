...
namespace Merge.AccountingClient.Model
{
    ...
    public partial class Invoice : IEquatable<Invoice>, IValidatableObject
    {
        ...
        public Invoice(InvoiceTypeEnum? type = default(InvoiceTypeEnum?), Guid? contact = default(Guid?), string number = default(string), DateTime? issueDate = default(DateTime?), DateTime? dueDate = default(DateTime?), DateTime? paidOnDate = default(DateTime?), string memo = default(string), Guid? company = default(Guid?), CurrencyEnum? currency = default(CurrencyEnum?), decimal? exchangeRate = default(decimal?), double? totalDiscount = default(double?), double? subTotal = default(double?), double? totalTaxAmount = default(double?), double? totalAmount = default(double?), double? balance = default(double?), DateTime? remoteUpdatedAt = default(DateTime?), List<Guid?> trackingCategories = default(List<Guid?>), List<Guid?> payments = default(List<Guid?>), string remoteId = default(string))
        {
            this.Type = type;
