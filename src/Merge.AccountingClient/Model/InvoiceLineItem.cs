...
namespace Merge.AccountingClient.Model
{
    ...
    public partial class InvoiceLineItem : IEquatable<InvoiceLineItem>, IValidatableObject
    {
        ...
        public InvoiceLineItem(string remoteId = default(string), string description = default(string), double? unitPrice = default(double?), double? quantity = default(double?), double? totalAmount = default(double?), CurrencyEnum? currency = default(CurrencyEnum?), decimal? exchangeRate = default(decimal?), Guid? item = default(Guid?), Guid? account = default(Guid?), Guid? trackingCategory = default(Guid?), List<Guid?> trackingCategories = default(List<Guid?>), Guid? company = default(Guid?))
        {
