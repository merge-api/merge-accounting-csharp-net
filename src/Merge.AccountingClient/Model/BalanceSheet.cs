...
namespace Merge.AccountingClient.Model
{
    ...
    public partial class BalanceSheet : IEquatable<BalanceSheet>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The balance sheet&#39;s currency.</value>
        ...
        /// <param name="currency">The balance sheet&#39;s currency..</param>
        /// <param name="company">The company the balance sheet belongs to..</param>
        ...
        public BalanceSheet(string remoteId = default(string), string name = default(string), CurrencyEnum? currency = default(CurrencyEnum?), Guid? company = default(Guid?), DateTime? date = default(DateTime?), float? netAssets = default(float?), DateTime? remoteGeneratedAt = default(DateTime?))
        {
        ...
        /// </summary>
        /// <value>The company the balance sheet belongs to.</value>
