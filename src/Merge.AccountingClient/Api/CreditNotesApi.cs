...
namespace Merge.AccountingClient.Api
{
    ...
    public interface ICreditNotesApiSync : IApiAccessor
    {
        ...
        CreditNote CreditNotesRetrieve(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?));
        ...
        ApiResponse<CreditNote> CreditNotesRetrieveWithHttpInfo(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?));
    ...
    public interface ICreditNotesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CreditNote> CreditNotesRetrieveAsync(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<CreditNote>> CreditNotesRetrieveWithHttpInfoAsync(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class CreditNotesApi : ICreditNotesApi
    {
        ...
        {
            Merge.AccountingClient.Client.ApiResponse<PaginatedCreditNoteList> localVarResponse = CreditNotesListWithHttpInfo(xAccountToken, createdAfter, createdBefore, cursor, expand, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
        ...
        {
            Merge.AccountingClient.Client.ApiResponse<PaginatedCreditNoteList> localVarResponse = await CreditNotesListWithHttpInfoAsync(xAccountToken, createdAfter, createdBefore, cursor, expand, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="includeRemoteData">Whether to include the original data Merge fetched from the third-party to produce these models. (optional)</param>
        /// <returns>CreditNote</returns>
        public CreditNote CreditNotesRetrieve(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?))
        {
            Merge.AccountingClient.Client.ApiResponse<CreditNote> localVarResponse = CreditNotesRetrieveWithHttpInfo(xAccountToken, id, expand, includeRemoteData);
            return localVarResponse.Data;
        }
        ...
        /// <param name="includeRemoteData">Whether to include the original data Merge fetched from the third-party to produce these models. (optional)</param>
        /// <returns>ApiResponse of CreditNote</returns>
        public Merge.AccountingClient.Client.ApiResponse<CreditNote> CreditNotesRetrieveWithHttpInfo(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?))
        {
            // verify the required parameter 'xAccountToken' is set
            if (xAccountToken == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CreditNote</returns>
        public async System.Threading.Tasks.Task<CreditNote> CreditNotesRetrieveAsync(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Merge.AccountingClient.Client.ApiResponse<CreditNote> localVarResponse = await CreditNotesRetrieveWithHttpInfoAsync(xAccountToken, id, expand, includeRemoteData, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CreditNote)</returns>
        public async System.Threading.Tasks.Task<Merge.AccountingClient.Client.ApiResponse<CreditNote>> CreditNotesRetrieveWithHttpInfoAsync(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'xAccountToken' is set
            if (xAccountToken == null)
                throw new Merge.AccountingClient.Client.ApiException(400, "Missing required parameter 'xAccountToken' when calling CreditNotesApi->CreditNotesRetrieve");
