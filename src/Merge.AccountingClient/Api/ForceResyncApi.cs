...
namespace Merge.AccountingClient.Api
{
    ...
    public partial class ForceResyncApi : IForceResyncApi
    {
        ...
        /// <returns></returns>
        public ForceResyncApi(Merge.AccountingClient.Client.Configuration configuration)
        {
        ...
        public ForceResyncApi(Merge.AccountingClient.Client.ISynchronousClient client, Merge.AccountingClient.Client.IAsynchronousClient asyncClient, Merge.AccountingClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Merge.AccountingClient.Client.ApiResponse<List<SyncStatus>> localVarResponse = SyncStatusResyncCreateWithHttpInfo(xAccountToken);
        ...
        /// <param name="xAccountToken">Token identifying the end user.</param>
        /// <returns>ApiResponse of List&lt;SyncStatus&gt;</returns>
        public Merge.AccountingClient.Client.ApiResponse<List<SyncStatus>> SyncStatusResyncCreateWithHttpInfo(string xAccountToken)
        {
            // verify the required parameter 'xAccountToken' is set
            if (xAccountToken == null)
                throw new Merge.AccountingClient.Client.ApiException(400, "Missing required parameter 'xAccountToken' when calling ForceResyncApi->SyncStatusResyncCreate");
        ...
        {
            Merge.AccountingClient.Client.ApiResponse<List<SyncStatus>> localVarResponse = await SyncStatusResyncCreateWithHttpInfoAsync(xAccountToken, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;SyncStatus&gt;)</returns>
        public async System.Threading.Tasks.Task<Merge.AccountingClient.Client.ApiResponse<List<SyncStatus>>> SyncStatusResyncCreateWithHttpInfoAsync(string xAccountToken, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'xAccountToken' is set
            if (xAccountToken == null)
                throw new Merge.AccountingClient.Client.ApiException(400, "Missing required parameter 'xAccountToken' when calling ForceResyncApi->SyncStatusResyncCreate");
