...
namespace Merge.AccountingClient.Api
{
    ...
    public partial class IssuesApi : IIssuesApi
    {
        ...
        {
            Merge.AccountingClient.Client.ApiResponse<PaginatedIssueList> localVarResponse = IssuesListWithHttpInfo(accountToken, cursor, endDate, endUserOrganizationName, firstIncidentTimeAfter, firstIncidentTimeBefore, includeMuted, integrationName, lastIncidentTimeAfter, lastIncidentTimeBefore, pageSize, startDate, status);
        ...
        public Merge.AccountingClient.Client.ApiResponse<PaginatedIssueList> IssuesListWithHttpInfo(string accountToken = default(string), string cursor = default(string), string endDate = default(string), string endUserOrganizationName = default(string), DateTime? firstIncidentTimeAfter = default(DateTime?), DateTime? firstIncidentTimeBefore = default(DateTime?), string includeMuted = default(string), string integrationName = default(string), DateTime? lastIncidentTimeAfter = default(DateTime?), DateTime? lastIncidentTimeBefore = default(DateTime?), int? pageSize = default(int?), string startDate = default(string), string status = default(string))
        {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Merge.AccountingClient.Client.ClientUtils.ParameterToMultiMap("", "first_incident_time_after", firstIncidentTimeAfter));
            }
            if (firstIncidentTimeBefore != null)
            {
                localVarRequestOptions.QueryParameters.Add(Merge.AccountingClient.Client.ClientUtils.ParameterToMultiMap("", "first_incident_time_before", firstIncidentTimeBefore));
            }
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Merge.AccountingClient.Client.ClientUtils.ParameterToMultiMap("", "last_incident_time_after", lastIncidentTimeAfter));
            }
            if (lastIncidentTimeBefore != null)
            {
                localVarRequestOptions.QueryParameters.Add(Merge.AccountingClient.Client.ClientUtils.ParameterToMultiMap("", "last_incident_time_before", lastIncidentTimeBefore));
            }
            if (pageSize != null)
            {
