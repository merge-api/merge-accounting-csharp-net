...
namespace Merge.AccountingClient.Api
{
    ...
    public partial class AccountTokenApi : IAccountTokenApi
    {
        ...
        /// <returns></returns>
        public AccountTokenApi(Merge.AccountingClient.Client.Configuration configuration)
        {
        ...
        public AccountTokenApi(Merge.AccountingClient.Client.ISynchronousClient client, Merge.AccountingClient.Client.IAsynchronousClient asyncClient, Merge.AccountingClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Merge.AccountingClient.Client.ApiResponse<AccountToken> localVarResponse = AccountTokenRetrieveWithHttpInfo(publicToken);
        ...
        /// <param name="publicToken"></param>
        /// <returns>ApiResponse of AccountToken</returns>
        public Merge.AccountingClient.Client.ApiResponse<AccountToken> AccountTokenRetrieveWithHttpInfo(string publicToken)
        {
            // verify the required parameter 'publicToken' is set
            if (publicToken == null)
                throw new Merge.AccountingClient.Client.ApiException(400, "Missing required parameter 'publicToken' when calling AccountTokenApi->AccountTokenRetrieve");
            ...
            localVarRequestOptions.PathParameters.Add("public_token", Merge.AccountingClient.Client.ClientUtils.ParameterToString(publicToken)); // path parameter
        ...
        {
            Merge.AccountingClient.Client.ApiResponse<AccountToken> localVarResponse = await AccountTokenRetrieveWithHttpInfoAsync(publicToken, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AccountToken)</returns>
        public async System.Threading.Tasks.Task<Merge.AccountingClient.Client.ApiResponse<AccountToken>> AccountTokenRetrieveWithHttpInfoAsync(string publicToken, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'publicToken' is set
            if (publicToken == null)
                throw new Merge.AccountingClient.Client.ApiException(400, "Missing required parameter 'publicToken' when calling AccountTokenApi->AccountTokenRetrieve");
