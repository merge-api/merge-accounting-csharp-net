...
namespace Merge.AccountingClient.Api
{
    ...
    public partial class RegenerateKeyApi : IRegenerateKeyApi
    {
        ...
        /// <returns></returns>
        public RegenerateKeyApi(Merge.AccountingClient.Client.Configuration configuration)
        {
        ...
        public RegenerateKeyApi(Merge.AccountingClient.Client.ISynchronousClient client, Merge.AccountingClient.Client.IAsynchronousClient asyncClient, Merge.AccountingClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Merge.AccountingClient.Client.ApiResponse<RemoteKey> localVarResponse = RegenerateKeyCreateWithHttpInfo(remoteKeyForRegenerationRequest);
        ...
        /// <param name="remoteKeyForRegenerationRequest"></param>
        /// <returns>ApiResponse of RemoteKey</returns>
        public Merge.AccountingClient.Client.ApiResponse<RemoteKey> RegenerateKeyCreateWithHttpInfo(RemoteKeyForRegenerationRequest remoteKeyForRegenerationRequest)
        {
            // verify the required parameter 'remoteKeyForRegenerationRequest' is set
            if (remoteKeyForRegenerationRequest == null)
                throw new Merge.AccountingClient.Client.ApiException(400, "Missing required parameter 'remoteKeyForRegenerationRequest' when calling RegenerateKeyApi->RegenerateKeyCreate");
        ...
        {
            Merge.AccountingClient.Client.ApiResponse<RemoteKey> localVarResponse = await RegenerateKeyCreateWithHttpInfoAsync(remoteKeyForRegenerationRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RemoteKey)</returns>
        public async System.Threading.Tasks.Task<Merge.AccountingClient.Client.ApiResponse<RemoteKey>> RegenerateKeyCreateWithHttpInfoAsync(RemoteKeyForRegenerationRequest remoteKeyForRegenerationRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'remoteKeyForRegenerationRequest' is set
            if (remoteKeyForRegenerationRequest == null)
                throw new Merge.AccountingClient.Client.ApiException(400, "Missing required parameter 'remoteKeyForRegenerationRequest' when calling RegenerateKeyApi->RegenerateKeyCreate");
