...
namespace Merge.AccountingClient.Api
{
    ...
    public interface IInvoicesApiSync : IApiAccessor
    {
        ...
        Invoice InvoicesRetrieve(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?));
        ...
        ApiResponse<Invoice> InvoicesRetrieveWithHttpInfo(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?));
    ...
    public interface IInvoicesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Invoice> InvoicesRetrieveAsync(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Invoice>> InvoicesRetrieveWithHttpInfoAsync(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class InvoicesApi : IInvoicesApi
    {
        ...
        {
            Merge.AccountingClient.Client.ApiResponse<PaginatedInvoiceList> localVarResponse = InvoicesListWithHttpInfo(xAccountToken, contactId, createdAfter, createdBefore, cursor, expand, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
        ...
        {
            Merge.AccountingClient.Client.ApiResponse<PaginatedInvoiceList> localVarResponse = await InvoicesListWithHttpInfoAsync(xAccountToken, contactId, createdAfter, createdBefore, cursor, expand, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="includeRemoteData">Whether to include the original data Merge fetched from the third-party to produce these models. (optional)</param>
        /// <returns>Invoice</returns>
        public Invoice InvoicesRetrieve(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?))
        {
            Merge.AccountingClient.Client.ApiResponse<Invoice> localVarResponse = InvoicesRetrieveWithHttpInfo(xAccountToken, id, expand, includeRemoteData);
            return localVarResponse.Data;
        }
        ...
        /// <param name="includeRemoteData">Whether to include the original data Merge fetched from the third-party to produce these models. (optional)</param>
        /// <returns>ApiResponse of Invoice</returns>
        public Merge.AccountingClient.Client.ApiResponse<Invoice> InvoicesRetrieveWithHttpInfo(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?))
        {
            // verify the required parameter 'xAccountToken' is set
            if (xAccountToken == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Invoice</returns>
        public async System.Threading.Tasks.Task<Invoice> InvoicesRetrieveAsync(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Merge.AccountingClient.Client.ApiResponse<Invoice> localVarResponse = await InvoicesRetrieveWithHttpInfoAsync(xAccountToken, id, expand, includeRemoteData, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
