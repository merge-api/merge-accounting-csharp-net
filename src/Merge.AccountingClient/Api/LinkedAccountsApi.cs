...
namespace Merge.AccountingClient.Api
{
    ...
    public partial class LinkedAccountsApi : ILinkedAccountsApi
    {
        ...
        {
            Merge.AccountingClient.Client.ApiResponse<PaginatedAccountDetailsAndActionsList> localVarResponse = LinkedAccountsListWithHttpInfo(category, cursor, endUserEmailAddress, endUserOrganizationName, endUserOriginId, endUserOriginIds, id, ids, includeDuplicates, integrationName, isTestAccount, pageSize, status);
        ...
        public Merge.AccountingClient.Client.ApiResponse<PaginatedAccountDetailsAndActionsList> LinkedAccountsListWithHttpInfo(string category = default(string), string cursor = default(string), string endUserEmailAddress = default(string), string endUserOrganizationName = default(string), string endUserOriginId = default(string), string endUserOriginIds = default(string), Guid? id = default(Guid?), string ids = default(string), bool? includeDuplicates = default(bool?), string integrationName = default(string), string isTestAccount = default(string), int? pageSize = default(int?), string status = default(string))
        {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Merge.AccountingClient.Client.ClientUtils.ParameterToMultiMap("", "include_duplicates", includeDuplicates));
            }
