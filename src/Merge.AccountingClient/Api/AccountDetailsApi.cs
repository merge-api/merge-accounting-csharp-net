...
namespace Merge.AccountingClient.Api
{
    ...
    public partial class AccountDetailsApi : IAccountDetailsApi
    {
        ...
        /// <returns></returns>
        public AccountDetailsApi(Merge.AccountingClient.Client.Configuration configuration)
        {
        ...
        public AccountDetailsApi(Merge.AccountingClient.Client.ISynchronousClient client, Merge.AccountingClient.Client.IAsynchronousClient asyncClient, Merge.AccountingClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Merge.AccountingClient.Client.ApiResponse<AccountDetails> localVarResponse = AccountDetailsRetrieveWithHttpInfo(xAccountToken);
        ...
        /// <param name="xAccountToken">Token identifying the end user.</param>
        /// <returns>ApiResponse of AccountDetails</returns>
        public Merge.AccountingClient.Client.ApiResponse<AccountDetails> AccountDetailsRetrieveWithHttpInfo(string xAccountToken)
        {
            // verify the required parameter 'xAccountToken' is set
            if (xAccountToken == null)
                throw new Merge.AccountingClient.Client.ApiException(400, "Missing required parameter 'xAccountToken' when calling AccountDetailsApi->AccountDetailsRetrieve");
        ...
        {
            Merge.AccountingClient.Client.ApiResponse<AccountDetails> localVarResponse = await AccountDetailsRetrieveWithHttpInfoAsync(xAccountToken, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AccountDetails)</returns>
        public async System.Threading.Tasks.Task<Merge.AccountingClient.Client.ApiResponse<AccountDetails>> AccountDetailsRetrieveWithHttpInfoAsync(string xAccountToken, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'xAccountToken' is set
            if (xAccountToken == null)
                throw new Merge.AccountingClient.Client.ApiException(400, "Missing required parameter 'xAccountToken' when calling AccountDetailsApi->AccountDetailsRetrieve");
