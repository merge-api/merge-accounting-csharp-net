...
namespace Merge.AccountingClient.Api
{
    ...
    public partial class AccountDetailsApi : IAccountDetailsApi
    {
        ...
        {
            Merge.AccountingClient.Client.ApiResponse<AccountDetails> localVarResponse = AccountDetailsRetrieveWithHttpInfo();
        ...
        /// <exception cref="Merge.AccountingClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of AccountDetails</returns>
        public Merge.AccountingClient.Client.ApiResponse<AccountDetails> AccountDetailsRetrieveWithHttpInfo()
        {
        ...
        {
            Merge.AccountingClient.Client.ApiResponse<AccountDetails> localVarResponse = await AccountDetailsRetrieveWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AccountDetails)</returns>
        public async System.Threading.Tasks.Task<Merge.AccountingClient.Client.ApiResponse<AccountDetails>> AccountDetailsRetrieveWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
