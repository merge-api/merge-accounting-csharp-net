...
namespace Merge.AccountingClient.Api
{
    ...
    public interface IItemsApiSync : IApiAccessor
    {
        ...
        Item ItemsRetrieve(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?));
        ...
        ApiResponse<Item> ItemsRetrieveWithHttpInfo(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?));
    ...
    public interface IItemsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Item> ItemsRetrieveAsync(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Item>> ItemsRetrieveWithHttpInfoAsync(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ItemsApi : IItemsApi
    {
        ...
        {
            Merge.AccountingClient.Client.ApiResponse<PaginatedItemList> localVarResponse = ItemsListWithHttpInfo(xAccountToken, createdAfter, createdBefore, cursor, expand, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
        ...
        {
            Merge.AccountingClient.Client.ApiResponse<PaginatedItemList> localVarResponse = await ItemsListWithHttpInfoAsync(xAccountToken, createdAfter, createdBefore, cursor, expand, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="includeRemoteData">Whether to include the original data Merge fetched from the third-party to produce these models. (optional)</param>
        /// <returns>Item</returns>
        public Item ItemsRetrieve(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?))
        {
            Merge.AccountingClient.Client.ApiResponse<Item> localVarResponse = ItemsRetrieveWithHttpInfo(xAccountToken, id, expand, includeRemoteData);
            return localVarResponse.Data;
        }
        ...
        /// <param name="includeRemoteData">Whether to include the original data Merge fetched from the third-party to produce these models. (optional)</param>
        /// <returns>ApiResponse of Item</returns>
        public Merge.AccountingClient.Client.ApiResponse<Item> ItemsRetrieveWithHttpInfo(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?))
        {
            // verify the required parameter 'xAccountToken' is set
            if (xAccountToken == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Item</returns>
        public async System.Threading.Tasks.Task<Item> ItemsRetrieveAsync(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Merge.AccountingClient.Client.ApiResponse<Item> localVarResponse = await ItemsRetrieveWithHttpInfoAsync(xAccountToken, id, expand, includeRemoteData, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Item)</returns>
        public async System.Threading.Tasks.Task<Merge.AccountingClient.Client.ApiResponse<Item>> ItemsRetrieveWithHttpInfoAsync(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'xAccountToken' is set
            if (xAccountToken == null)
                throw new Merge.AccountingClient.Client.ApiException(400, "Missing required parameter 'xAccountToken' when calling ItemsApi->ItemsRetrieve");
